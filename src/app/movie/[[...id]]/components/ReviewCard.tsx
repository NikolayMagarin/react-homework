...
export default function ReviewCard({
  ...
  reviewData: { id: string; name: string; text: string; rating: number };
}) {
  return (
    <div className={styles.reviewCard}>
      ...
      <div className={styles.reviewContent}>
        <div className={styles.title}>
          <strong className={styles.name}>{reviewData.name}</strong>
          <div className={styles.rating}>
            <span>Оценка:</span>
            <strong>{reviewData.rating}</strong>
          </div>
        </div>
        <p className={styles.text}>{reviewData.text}</p>
      </div>
    </div>
  );
}
